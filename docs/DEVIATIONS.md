...
| 开班与维护 | 班级、学期、导入、布局、标记、模板、改密、审计、备份、花名册和积分导出、匿名化都有操作入口 | 学期、班级、名单和机房布局已在页面上。标记、模板、改密、审计、备份、花名册和积分导出、匿名化仍只有接口。没有班级时，课堂等页显示「还没有可以上课的班级」。清单见 `docs/API.md`「页面是否调用」，步骤见 `docs/使用教程.md` |
