...
export type RollcallScopeInput = z.infer<typeof rollcallScope>;
...
export type OpenRollcallInput = z.infer<typeof openRollcallInput>;

export const drawRollcallInput = z.object({
  count: z.number().int().min(1).max(200),
  request_id: requestId,
});
export type DrawRollcallInput = z.infer<typeof drawRollcallInput>;

export const excludeRollcallInput = z.object({
  student_ids: z.array(uuid).min(1).max(500),
  request_id: requestId,
});
export type ExcludeRollcallInput = z.infer<typeof excludeRollcallInput>;

export const closeRollcallInput = z.object({
  request_id: requestId,
});
export type CloseRollcallInput = z.infer<typeof closeRollcallInput>;

export const countdownAction = z.enum(['start', 'pause', 'resume', 'reset']);
export type CountdownActionName = z.infer<typeof countdownAction>;
...
export type CountdownCommandInput = z.infer<typeof countdownCommandInput>;
